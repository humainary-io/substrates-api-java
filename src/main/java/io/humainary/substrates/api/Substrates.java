...
public interface Substrates {
  ...
  interface Circuit
    ...
    ///
    /// A dedicated virtual thread sleeps for the configured interval, then
    /// submits a tick job carrying the next sequence number to this circuit.
    /// The first emission carries sequence `0`; each subsequent emission
  ...
  /// circuits, names, scopes, slots, states, and subscribers. Each component type
  ...
  interface Registrar < E > {
    ...
    /// are preserved.
    ///
    /// Relative invocation order across mixed receptor and pipe registrations is unspecified.
    /// The registration-order guarantee of [#register(Pipe)] applies among pipe registrations.
    ///
    /// ## Temporal Constraint
    ///
    /// **MUST be called only within the subscriber callback** that provided this registrar.
