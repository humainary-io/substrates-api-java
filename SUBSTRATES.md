...
ingress admission path requires synchronization only at the admission boundary. Once work enters
the circuit context, all processing including cascading is lock-free.
...
- **Fiber.limit()**: Caps the number of emissions processed by a Fiber stage. After the limit,
