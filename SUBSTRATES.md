...
- **Substrate** (`subject()`): Cortex, Circuit, Conduit, Sink, Bank, Cell, Port, Pin, Ticker, Pipe,
  Current, Scope, Basin, Tap, Subscriber, Subscription
- **Resource** (adds `close()`): Circuit, Conduit, Tap, Bank, Ticker, Subscriber, Subscription
- **Source** (adds `subscribe()`): Circuit, Conduit, Tap
