...
The API defines 35 interfaces. Each one exists for a specific structural reason — performance,
...
The 35 interfaces are not equally central. Most users need only the core layer to build with
...
The API defines 35 interfaces. This section explains why.
