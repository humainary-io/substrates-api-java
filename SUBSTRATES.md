...
| Capture   | Emission + subject pair (produced by Reservoir or Sink) |
...
- **Substrate** (`subject()`): Cortex, Circuit, Conduit, Sink, Bank, Cell, Port, Pin, Ticker, Pipe,
  Current, Scope, Reservoir, Tap, Subscriber, Subscription
- **Resource** (adds `close()`): Circuit, Conduit, Tap, Bank, Ticker, Reservoir, Subscriber,
  Subscription
