...
|------------------------|-------|------------|-------------------------------------------------------------------------------------------------------------------------|
| **Operation**          | 30    | 24%        | All except Logs, Valves, Systems, Flows; includes Latches, Exchanges, Operations (BEGIN/END), Atomics                   |
| **Outcome**            | 26    | 21%        | All except Queues, Logs, Valves, Pools, Stacks, Systems, Latches; includes Outcomes, Atomics, Flows, Timers (MEET/MISS) |
...
**Total unique signs analyzed**: ~121 across 20 APIs (including Systems, Exchanges, Outcomes,
Operations, Trends, Atomics, Flows, Timers)
...
- **Surveys**: (Sign × DIVIDED/MAJORITY/UNANIMOUS) (how much do we agree?)
