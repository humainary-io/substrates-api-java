...
import io.humainary.substrates.ext.serventis.sdk.Statuses.Dimension;
import io.humainary.substrates.ext.serventis.sdk.Statuses.Sign;
...
final class StatusesTest {
  ...
  void testMultiServiceMonitoring () {
    ...
    final var conduit = circuit.conduit ( Statuses::composer );
