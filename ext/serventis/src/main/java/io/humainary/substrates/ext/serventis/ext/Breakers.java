...
import static io.humainary.substrates.ext.serventis.ext.Breakers.Sign.*;
...
/// - **Monitors API**: Breaker state (OPEN) may indicate DEGRADED or DOWN conditions
/// - **Resources API**: Resource DEPLETED may correlate with breaker OPEN
/// - **Reporters API**: Sustained OPEN state may escalate to HIGH or CRITICAL situations
