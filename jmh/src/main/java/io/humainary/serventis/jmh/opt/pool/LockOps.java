...
import io.humainary.substrates.ext.serventis.opt.pool.Locks;
import io.humainary.substrates.ext.serventis.opt.pool.Locks.Lock;
import io.humainary.substrates.ext.serventis.opt.pool.Locks.Sign;
import org.openjdk.jmh.annotations.*;

import static io.humainary.substrates.ext.serventis.opt.pool.Locks.Sign.ATTEMPT;
