...
public class SubscriberOps {
  ...
  @Benchmark
  public void close_no_subscriptions_await (
  ...
  public void close_no_subscriptions_batch_await (
  ...
  @Benchmark
  public void close_one_subscription_await (
  ...
  @Benchmark
  @OperationsPerInvocation ( BATCH_SIZE )
  public void close_one_subscription_batch_await (
  ...
  @Benchmark
  public void close_five_subscriptions_await (
  ...
  @Benchmark
  public void close_ten_subscriptions_await (
  ...
  @Benchmark
  public void close_five_conduits_await (
  ...
  @Benchmark
  public void close_ten_conduits_await (
  ...
  @Benchmark
  public void close_idempotent_await (
  ...
  @Benchmark
  @OperationsPerInvocation ( BATCH_SIZE )
  public void close_idempotent_batch_await (
    final IdempotentCloseState state
  ) {
  ...
  @Benchmark
  public void close_with_pending_emissions_await (
