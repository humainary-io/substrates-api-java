...
public class NameOps
  ...
  @Benchmark
  @OperationsPerInvocation ( BATCH_SIZE )
  public boolean name_within_batch () {
    boolean result = false;
    for ( var i = 0; i < BATCH_SIZE; i++ ) result = deepName.within ( rootName );
    return result;
  }
  ...
  @Benchmark
  @OperationsPerInvocation ( BATCH_SIZE )
  public boolean name_within_false_batch () {
    boolean result = false;
    for ( var i = 0; i < BATCH_SIZE; i++ ) result = deepName.within ( unrelatedName );
    return result;
  }
  ...
  @Benchmark
  @OperationsPerInvocation ( BATCH_SIZE )
  public int name_hashCode_batch () {
    int result = 0;
    for ( var i = 0; i < BATCH_SIZE; i++ ) result = deepName.hashCode ();
    return result;
  }
