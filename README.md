...
# Using tck.sh with custom SPI (via environment variables)
SPI_GROUP=com.example SPI_ARTIFACT=my-substrates-spi SPI_VERSION=1.0.0 ./tck.sh
```
...
# Benchmark with custom SPI (via environment variables)
SPI_GROUP=com.example SPI_ARTIFACT=my-substrates-spi SPI_VERSION=1.0.0 ./jmh.sh
```
