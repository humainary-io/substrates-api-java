...
try {
  ...
  circuit.await (); // 3 and 5 have been observed before continuing
...
`closeAwait` closes the circuit and waits for cleanup before the example exits.
...
Substrates 3.1.2 requires Java 26.
...
- [Substrates 101: Pipes, Observers, and Processing](TUTORIAL.md) introduces pipes,
  conduits, subscriptions, fibers, and flows through small temperature-reading examples.
